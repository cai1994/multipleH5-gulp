 ...
 * @page: 表单格式校验
 * @Author: songxiaoyu
 * @Date:   2018-08-15 16:06:59
 * @Last Modified by:   songxiaoyu
 * @Last Modified time: 2018-08-20 17:42:04
 * @description:
 */

var regList = require('../../../../js/util/regList.js').default;
...
module.exports = {
  ...
  // 预约单号暂时处理
  isReservationNumber:function(str){
    console.log('1.是否为空   str:' + str);
    if (!str ||  str == "请选择") {
      return false;
    }
  ...
  isSameNumber: function(str) {
    ...
    var r = regList.isSameNumber(str, beginNum);
