...
module.exports = function(options ){
	...
	//打包common/include里的js文件
	var jsArr = ['src/common/header/header.js' ];
	...
	gulp.task("webpack", function() {
	    ...
	    return gulp.src( ['src/common/header/header.js' ], {base:'src'})
	        ...
	        .pipe(gulp.dest(options.path + 'commonResources/' ))
