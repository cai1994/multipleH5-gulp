...
module.exports = function( options ){
	...
	var lessArr = ['common/include/error/**/*.less']
	...
	// 	return gulp.src(['src/common/header/header.less'] , {base:'src'})
			
	// 		//.pipe( plugins.concat('base.less') )

	// 		.pipe(plugins.less())

	// 		.pipe(gulp.dest(options.path+'commonResources/header/'))
	// })
	...
	gulp.task("less", function() {
	    ...
	    return gulp.src( changeObj , {base:'common'})
	        ...
	        // 		if( filePath.indexOf('commonResources\\richModules') == -1){
    					// //读取base.css内容
    					// var baseCss = fs.readFileSync( options.middle + 'common/less/base.less','utf-8');
